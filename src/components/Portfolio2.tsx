        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                <a href="#">
                  <img className="card-img-top" src="images/p7.png" alt="" />
                </a>
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                  ...
                  <p className="card-text">
                    เป้าหมายของกลยุทธ์การแข่งขันแบบร่วมมือกัน คือ
                    การทำให้คู่แข่งหลุดพ้นจากเกมผลรวมเป็นศูนย์
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                <a href="#">
                  <img className="card-img-top" src="images/p8.png" alt="" />
                </a>
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Technostructural1-32.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      การออกแบบงาน
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Technostructural33-54.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      การ Coaching
                  ...
                  <p className="card-text">
                    กระบวนการทำงานร่วมกันระหว่างโค้ชซึ่งเป็นเพื่อนชวนคิด
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Technostructural55-77.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      การสร้างทีม
            ...
            <div className="col-lg-6 portfolio-item">
              <div className="card h-100">
                ...
                <div className="card-body">
                  <h4 className="card-title">
                    <a
                      href="assets/Technostructural78-123.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <p className="card-text">
                    กระบวนการพัฒนาวัฒนธรรมองค์กรของคุณในรูปแบบที่แท้จริงซึ่งดึงดูดผู้คนและสร้างแรงบันดาลใจให้ทีมทำงานได้อย่างเต็มประสิทธิภาพ
