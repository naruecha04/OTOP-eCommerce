                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    <h2 className="card-title">
                      {" "}
                      การพัฒนาคุณภาพการบริหารการจัดการภาครัฐ 4.0
                    </h2>
                    <p className="card-text">
                      ...
                      เพื่อให้การให้บริการแก่ประชาชน
                    </p>
                    <a
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ...
                      เพื่อการเปลี่ยนและการพัฒนาองค์กรในภาครัฐ
                    </p>
                    <a
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ...
                      เพื่อการพัฒนาคุณภาพการบริหารจัดการภาครัฐในยุคดิจิทัลและ AI
                    </p>
                    <a
